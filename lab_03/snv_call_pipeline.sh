...
## Example usage:
## ./lab_02_snv_call.sh hl60_brca1 ./resources ./intermediates ./results

## This script performs single nucleotide variant (SNV) calling on input paired-end sequencing data (fastq.gz files)
## The pipeline includes quality control, adapter trimming, read alignment, duplicate marking, and variant calling.
## Key tools used: FastQC, Cutadapt, BWA, Samtools, GATK, Picard.


# Positional arguments and variables
SAMPLE_NAME=$1         # Name of the sample. Example: hl60_brca1
